                            ...
                            <v-row align="end">
                                <v-col cols='12'>
                                    <v-sheet dark color="rgba(0, 0, 0, .4)">
                                        <v-row class='pa-2'>
                                            <v-col cols='12'>
                                                <span class='text-h2'>Layhgobuilder Basic</span>
                                            </v-col>

                                            <v-col>
                                                <v-btn outlined v-if='hasPermission(["access_basic"])' @click='download(latest.destination, getOS.key)'>
                    ...
                    <v-layout>
                        <v-row v-scroll='onScroll' class='mt-2'>
                            <v-col cols='12'>
                                ...
                                <template v-if='hasPermission(["access_basic"])'>
                                    <v-row class='pa-2'>
                                    ...
                                    <v-row no-gutters class='pa-2' v-if='latest.id !== undefined'>
    ...
    computed: {
        ...
        releases() {
            ...
            if (releases !== undefined) {
                return Object.values(releases).filter(release => release.product === 'basic');
            }
