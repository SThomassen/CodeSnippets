    ...
    <v-container>
        ...
        <v-row class='mt-2'>
            <v-col>
                <v-row>
                    <v-col>
                        <v-parallax src='images/fieldlab_screenshot_2.png'>
                            <v-row align="end">
                                <v-col cols='12'>
                                    <v-sheet dark color="rgba(0, 0, 0, .4)">
                                        <v-row class='pa-2 align-end'>
                                            <v-col cols='12'>
                                                <span class='text-h2'>Layhgobuilder Fieldlab</span>
                                            </v-col>

                                            <template v-if='hasPermission(["access_fieldlab"])'>
                                                <v-col cols='auto'>
                                                    <v-btn outlined  @click='download(latest.destination, getOS.key)'>
                                                        {{$t('products.download_for', { name: getOS.value}) }}
                                                    </v-btn>
                                                </v-col>
                                                <!-- <v-col>
                                                    <v-btn x-small text>
                                                        {{$t('products.download_other')}}
                                                    </v-btn>
                                                </v-col> -->
                                            </template>
                                            <template v-else-if='user.id !== undefined'>
                                                <v-col>
                                                    <v-btn outlined @click='$bus.$emit("onOpenFieldlabLicense")'>
                            ...
                            <v-col cols='12'>
                                ...
                                <template v-else>
                                    <v-row class='pl-2 pr-2 mt-4' justify="center">
                                        <v-col>
                                            <p>You need register your account to gain access to the fieldlab version.</p>
                                        </v-col>
                                        <v-col>
    ...
    computed: {
        ...
        releases() {
            ...
            if (releases !== undefined) {
                releases = Object.values(releases).filter(release => release.product === 'fieldlab');
                return releases;
            }
            return {};
        },
